var Tetris = {
	...
	getBlockColor: function () { },	//ブロックの色をゲットする
}
...
/**
 * ブロックをdataに置く
 * @params int blockId	ブロックの状態(0:なし,1:壁＆床,2:落下中,3落下後)
 */
Tetris.putBlock = function (blockId) {
	var i, cx, cy;
